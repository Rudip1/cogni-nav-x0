...
#
#   We hardcode the system paths directly rather than reading os.environ
#   because launch files run in a subprocess where env vars may not be set.
#
# WHY TWO DELAYS:
...
#                         model.sdf (model:// URIs) doesn't need this delay.
#
...
def generate_launch_description():
    ...
    # This is required because SetEnvironmentVariable replaces by default,
    # and we cannot reliably read os.environ in the launch subprocess.
    ...
    # Publishes /robot_description topic + TF tree.
    # Uses xacro from vf_robot_description (single source of truth).
