...
#   Without RSP, RViz has no TF tree for the robot links.
#
# WHY GAZEBO_MODEL_PATH:
#   model.sdf uses model://uvc1_common/meshes/... URIs.
#   Gazebo needs to find uvc1_common in GAZEBO_MODEL_PATH.
#
...
def generate_launch_description():
    ...
    gazebo_model_path = SetEnvironmentVariable(
        ...
        value=os.pathsep.join(
            [
                os.path.join(pkg_vf_gazebo, "models"),  # uvc1_virofighter, uvc1_common
