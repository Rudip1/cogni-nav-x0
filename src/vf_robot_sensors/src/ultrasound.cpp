#include "vf_robot_model/ultrasound.h"
#include <vfmessages/msg/ultra_sound.hpp>  // ROS2 style include
...
: Node("ultrasound")  // ROS2 Node
{
    ...
    // Publisher
    ultrasound_publisher = this->create_publisher<vfmessages::msg::UltraSound>("/esp/range", 1);
